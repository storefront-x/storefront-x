...
A function, to wrap dynamically imported components to lazy hydrate, then loads it, when the browser is idle. More about lazy hydration [here](/general/lazy-components).
...
A function, to wrap dynamically imported components to lazy hydrate, then loads it, when the component is visible in the browser window. More about lazy hydration [here](/general/lazy-components).
