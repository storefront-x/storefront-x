...
You can find Cookie-script banner ID in your cookie-script dashboard. You need to override it by adding `config/COOKIE_SCRIPT_ID.ts` to your module. To see how overriding works, click [here](/getting-started/how-it-works.html#overriding).
