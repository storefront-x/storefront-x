<template>
  ...
  <div
    role="button"
    class="relative pl-2 text-gray-400 hover:text-gray-500 hover:cursor-pointer lg:block hidden lg:flex items-center justify-end"
    data-cy="minicart-button"
    @click.stop="cartStore.isMiniCartVisible = !cartStore.isMiniCartVisible"
  >
    <span class="text-black block mr-3">Můj košík</span>
    <div
      class="rounded-lg border-2 p-2 border-none border-gray-100 lg:border-solid hover:bg-gray-100 rounded-full lg:mr-2"
    >
      <OutlineShoppingBag class="text-primary-500" />
    </div>
    <span
