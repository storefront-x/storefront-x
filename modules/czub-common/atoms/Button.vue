  ...
  methods: {
    getColorClasses() {
      switch (this.color) {
        ...
        case 'primary':
          return {
            'focus:ring-primary-500 rounded-none': true,
            'bg-secondary-500 text-white': !this.outline,
            'hover:bg-primary-500 hover:transition-all hover:duration-256 hover:ease-bezier(0.33, 0.975, 0.245, 0.91) hover:border-primary-500':
              !this.outline && !this.disabled,
            'border-secondary-500 bg-white text-primary-600': this.outline,
