<template>
  <div
    class="group relative bg-white flex flex-col overflow-hidden border-r border-b border-gray-575 px-3 pt-3 pb-5 sm:pt-4 sm:px-5 sm:pb-6 rounded-lg sm:rounded-none"
  ...
  >
    <div class="flex sm:flex-col">
      ...
      <div class="flex-1 flex flex-col w-1/2 sm:w-full">
        ...
        <SfxMoney
          ...
          class="text-xl font-semibold text-red-555 mt-2 sm:mt-4 sm:text-center"
    ...
    <div class="flex sm:flex-col mt-auto sm:justify-center sm:w-1/2 sm:mx-auto">
      <AddToCart
        class="relative max-w-[50%] sm:max-w-full !mt-auto !ml-0 sm:mb-5 order-2 flex-1 sm:order-1 !h-8 sm:!h-[40px]"
      />
      <StockIndicator
