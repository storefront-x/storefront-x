<template>
  <div id="productOverview" class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:items-start relative mt-8">
    ...
    <div class="lg:col-span-5">
      ...
      <div class="mt-10 sm:px-0 sm:mt-16 lg:mt-0">
        <Heading :level="1" data-cy="title" class="font-black uppercase text-4xl">{{ product.name }}</Heading>

        <div class="flex items-center space-x-2 mt-4">
          <StockIndicator :stock-status="product.available" class="!mt-0" />
