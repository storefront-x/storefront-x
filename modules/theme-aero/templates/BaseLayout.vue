...
useHead({
  title: 'Vaclav Havel Airport Prague, Ruzyne | Vaclav Havel Airport Prague, Ruzyne',
  meta: [{ name: 'description', content: 'Vaclav Havel Airport Prague, Ruzyne | Vaclav Havel Airport Prague, Ruzyne' }],
})
</script>
