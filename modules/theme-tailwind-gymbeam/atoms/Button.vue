<template>
  <Component
    ...
    :to="to"
    :href="href"
    class="whitespace-nowrap rounded-md shadow-sm py-2 px-2 flex items-center font-bold justify-center text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2"
    :class="classes"
    :disabled="disabled"
    :title="title"
  >
