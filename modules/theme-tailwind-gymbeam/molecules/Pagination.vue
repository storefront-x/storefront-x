    ...
    >
      <div class="-mt-px flex order-2 justify-center basis-auto md:flex">
        <RouterLink
          v-if="leftLastItem"
          :to="getUrlFor(1)"
          class="hover:text-primary-500 hover:font-bold hover:bg-primary-500 md:hover:bg-inherit rounded-lg md:rounded-none md:border-t-2 border-transparent md:pt-4 px-2 md:px-4 inline-flex items-center font-base md:font-medium text-black md:text-primary-500 md:hover:text-gray-700 md:hover:border-gray-300"
        >
          {{ firstPage }}
        </RouterLink>
        <span
          v-if="leftSeparator"
          class="md:border-t-2 md:pt-4 md:px-4 inline-flex items-center font-base md:font-medium border-transparent text-primary-500"
          >...</span
        >
        <RouterLink
          v-for="page in pages"
          ...
          :class="[
            ...
            page === currentPage
              ? 'text-primary-500 font-bold bg-primary-500 rounded-lg md:border-primary-500 md:text-primary-600'
              : 'text-black hover:text-primary-500 hover:font-bold hover:bg-primary-500 rounded-lg md:border-transparent md:text-primary-500 md:hover:text-gray-700 md:hover:border-gray-300',
      ...
      <div class="ml-auto md:ml-0 w-auto md:my-0 md:flex-1 flex order-1 md:basis-auto md:order-1">
        <RouterLink
          ...
          class="border-t-2 border-transparent md:pt-4 pr-1 inline-flex items-center font-medium text-primary-500 hover:text-gray-700 hover:border-gray-300"
        >
          <SolidArrowLeft
      ...
      <div class="w-auto md:flex-1 flex order-2 justify-end md:basis-auto md:order-3">
        <RouterLink
          ...
          class="border-t-2 border-transparent md:pt-4 pl-1 inline-flex items-center font-medium text-primary-500 hover:text-gray-700 hover:border-gray-300"
        >
          <span class="hidden md:inline">
            {{ t('Next') }}
          </span>
